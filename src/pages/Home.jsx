...
const Home = () => {
 const {Submited, answer} = useFetchAnswer()
  return (
    <div className="flex flex-col items-center h-max justify-start px-3 gap-4 bg-neutral-900">
        <div className="flex items-end justify-start w-full gap-5 h-[554px] pt-5 overflow-scroll">
