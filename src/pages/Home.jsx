...
const Home = () => {
 const {Submited, answer} = useFetchAnswer()
  return (
    <div className="flex flex-col py-10 items-center h-max justify-end px-5">
        <div className="flex items-start justify-start w-full gap-5 h-[564px] overflow-scroll">
